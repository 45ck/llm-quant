#!/usr/bin/env python3
"""Robustness analysis for vcit-tqqq-sprint (Track D - Sprint Alpha).
...
Run: cd E:/llm-quant && PYTHONPATH=src python scripts/robustness_vcit_tqqq_sprint.py
"""
...
def cpcv_sharpe(returns, n_groups=15, k=3, purge=5):
    ...
    Uses 15 groups, 3 test per spec (more stringent than 6/2).
    """
...
# ==============================================================================
# CPCV (15 groups, 3 test, 5-day purge per spec)
# ==============================================================================
...
# ==============================================================================
# PERTURBATION TESTS (10 variants per spec)
# ==============================================================================
perturbations = [
    ...
    ("signal_window=15", {**BASE_PARAMS, "signal_window": 15}),
]
...
output = {
    ...
    "parent_strategy": "vcit-qqq-credit-lead (Track A, Sharpe=1.037)",
