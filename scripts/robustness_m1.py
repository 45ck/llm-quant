#!/usr/bin/env python3
"""Robustness analysis for M1: spy-gld-correlation-regime"""
...
SLUG = "spy-gld-correlation-regime"
SYMBOLS = ["SPY", "GLD"]
YEARS = 5
...
perturbations = [
    ...
    (
        "exit_thresh=0.0",
        {**base_params, "corr_exit_threshold": 0.0, "corr_entry_threshold": 0.0},
    ),
    (
        "exit_thresh=-0.10",
        {**base_params, "corr_exit_threshold": -0.10, "corr_entry_threshold": -0.10},
    ),
