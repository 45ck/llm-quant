#!/usr/bin/env python3
"""Robustness analysis for lqd-tqqq-credit-lead-lag (Track D).

Mechanism: LQD (IG credit) 5-day return as lead signal -> TQQQ (3x leveraged QQQ) follower.
This is a leveraged re-expression of the proven LQD-SPY credit lead signal (Sharpe=1.250).

Signal logic:
  - LQD 5-day return >= entry_threshold (0.5%) -> entry (buy TQQQ at target_weight)
...
Run: cd E:/llm-quant && PYTHONPATH=src python scripts/run_lqd_tqqq_sprint_robustness.py
"""
...
SLUG = "lqd-tqqq-credit-lead-lag"
SYMBOLS = ["LQD", "TQQQ", "SHY"]
DD_THRESHOLD = 0.40  # Track D: 40% max drawdown
LOOKBACK_DAYS = 5 * 365
WARMUP = 60

BASE_PARAMS = {
    "entry_threshold": 0.005,  # LQD 5-day return >= 0.5% -> buy TQQQ
...
output = {
    ...
    "track": "D",
    "mechanism": "LQD (IG credit) 5-day return -> TQQQ (3x leveraged QQQ)",
