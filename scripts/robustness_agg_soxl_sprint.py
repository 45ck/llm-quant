...
Mechanism: AGG (aggregate bond index) 10-day return as lead signal
-> SOXL (3x leveraged semiconductors) follower. AGG credit spread
...
Track D gates (leveraged):
  ...
  - Gate 2: MaxDD < 40%
  - Gate 3: DSR >= 0.90
  - Gate 4: CPCV OOS > 0 (15 groups, 2 test, 5-day purge)
