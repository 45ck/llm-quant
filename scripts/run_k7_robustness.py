#!/usr/bin/env python3
"""Robustness analysis for K7 risk-parity-correlation-regime."""
...
SLUG = "risk-parity-correlation-regime"
...
perturbations = [
    ...
    ("corr_window=25", {**BASE_PARAMS, "corr_window": 25}),
    (
        "exit_thresh=0.05",
        {
            **BASE_PARAMS,
    ...
    ("spy_weight=0.70", {**BASE_PARAMS, "spy_weight_risk_on": 0.70}),
]
