#!/usr/bin/env python3
"""Robustness analysis for ief-tqqq-sprint (Track D — Sprint Alpha).
...
Run: cd E:/llm-quant && PYTHONPATH=src python scripts/robustness_ief_tqqq_sprint.py
"""
...
# ==============================================================================
# PERTURBATION TESTS (11 variants as specified in research-spec)
# ==============================================================================
perturbations = [
    ("lag=1", {**BASE_PARAMS, "lag_days": 1}),
    ("lag=3", {**BASE_PARAMS, "lag_days": 3}),
    ("lag=4", {**BASE_PARAMS, "lag_days": 4}),
    ("entry=0.3%", {**BASE_PARAMS, "entry_threshold": 0.003}),
    ("entry=0.8%", {**BASE_PARAMS, "entry_threshold": 0.008}),
    ("exit=-0.2%", {**BASE_PARAMS, "exit_threshold": -0.002}),
    ("exit=-0.5%", {**BASE_PARAMS, "exit_threshold": -0.005}),
    ("weight=0.20", {**BASE_PARAMS, "target_weight": 0.20}),
    ("weight=0.40", {**BASE_PARAMS, "target_weight": 0.40}),
    ("rebalance=daily", {**BASE_PARAMS, "rebalance": "daily"}),
    ("rebalance=biweekly", {**BASE_PARAMS, "rebalance": "biweekly"}),
]
...
output = {
    ...
    "key_differentiator": "IEF reacts faster to Fed rate surprises than TLT; 2-day lag vs 3-day",
