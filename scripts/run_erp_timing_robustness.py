#!/usr/bin/env python3
"""Robustness analysis for erp-timing-v1 (K6, Equity Risk Premium Timing).

Mechanism: SPY-IEF 252-day relative return as ERP proxy.
...
Base parameters: lookback=252, cheap_thresh=-0.15, expensive_thresh=0.20,
...
Run: cd E:/llm-quant && PYTHONPATH=src python scripts/run_erp_timing_robustness.py
"""
...
def run_single(params):
    ...
    for i in range(WARMUP, n):
        ...
        # Compute relative return: SPY 252-day return minus IEF 252-day return
        spy_ret_252 = spy_now / spy_lb - 1
        ief_ret_252 = ief_now / ief_lb - 1
        relative_return = spy_ret_252 - ief_ret_252
...
# ==============================================================================
perturbations = [
    ("lookback=200", {**BASE_PARAMS, "lookback": 200}),
    ("lookback=300", {**BASE_PARAMS, "lookback": 300}),
