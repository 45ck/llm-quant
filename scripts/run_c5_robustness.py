#!/usr/bin/env python3
"""Robustness analysis for C5 vix-spike-spy-contrarian."""
...
perturbations = [
    ("spike_threshold=0.15", {**BASE_PARAMS, "spike_threshold": 0.15}),
    ("spike_threshold=0.25", {**BASE_PARAMS, "spike_threshold": 0.25}),
    ("spike_threshold=0.30", {**BASE_PARAMS, "spike_threshold": 0.30}),
