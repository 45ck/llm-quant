#!/usr/bin/env python3
"""Robustness analysis for uso-xle-mean-reversion-v1 (F2-Energy Mean Reversion).
...
Run: cd E:/llm-quant && PYTHONPATH=src python scripts/run_uso_xle_mean_reversion_robustness.py
"""
...
SLUG = "uso-xle-mean-reversion-v1"
SYMBOLS = ["USO", "XLE"]
DD_THRESHOLD = 0.15
LOOKBACK_DAYS = 5 * 365
WARMUP = 90
...
output = {
    ...
    "hypothesis": (
        ...
        "to XLE (z < -1), overweight USO. When XLE is cheap (z > +1), "
        "overweight XLE. Always holds both assets -- pairs trade, no SPY."
    ),
