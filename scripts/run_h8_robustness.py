#!/usr/bin/env python3
"""Robustness analysis for H8 btc-eem-lead-lag."""
...
SLUG = "btc-eem-lead-lag"
STRATEGY = "lead_lag"
SYMBOLS = ["BTC-USD", "EEM"]
DD_THRESHOLD = 0.20  # Higher for cross-asset crypto-originated signal
BASE_PARAMS = {
