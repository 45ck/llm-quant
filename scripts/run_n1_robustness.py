#!/usr/bin/env python3
"""Robustness analysis for N1 yield-curve-inversion-tlt."""
...
SLUG = "yield-curve-inversion-tlt"
STRATEGY = "yield_curve_regime"
SYMBOLS = ["TLT", "^IRX", "^TNX", "SPY"]
DD_THRESHOLD = 0.12
...
perturbations = [
    ...
    ("mode=momentum", {**BASE_PARAMS, "mode": "momentum"}),
    ("target_weight=0.80", {**BASE_PARAMS, "target_weight": 0.80}),
