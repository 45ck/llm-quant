#!/usr/bin/env python3
"""Robustness analysis for H6 cper-xlb-lead-lag."""
...
perturbations = [
    ...
    ("lag_days=6", {**BASE_PARAMS, "lag_days": 6}),
    ("entry_threshold=0.0075", {**BASE_PARAMS, "entry_threshold": 0.0075}),
    ("entry_threshold=0.030", {**BASE_PARAMS, "entry_threshold": 0.030}),
