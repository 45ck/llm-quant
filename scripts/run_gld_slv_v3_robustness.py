#!/usr/bin/env python3
"""Robustness analysis for gld-slv-mean-reversion-v3 (bb_window=90)."""
...
SLUG = "gld-slv-mean-reversion-v3"
...
perturbations = [
    ("bb_window=60", {**BASE_PARAMS, "bb_window": 60}),
    ("bb_window=120", {**BASE_PARAMS, "bb_window": 120}),
