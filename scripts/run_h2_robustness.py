#!/usr/bin/env python3
"""Robustness analysis for H2: hyg-spy-lead-lag."""
...
perturbations = [
    ...
    ("lag_days=0", {**BASE_PARAMS, "lag_days": 0}),
    ("entry_threshold=0.0025", {**BASE_PARAMS, "entry_threshold": 0.0025}),
